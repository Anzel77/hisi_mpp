...
HI_S32 LOTO_OPUS_StartAi(AUDIO_DEV AiDevId, HI_S32 s32AiChnCnt,
...
HI_S32 LOTO_OPUS_StopAi(AUDIO_DEV AiDevId, HI_S32 s32AiChnCnt,
...
HI_S32 LOTO_OPUS_InitEncoder(OpusEncoder **opusEncoder)
{
    ...
    if (g_stOpusEncFunc.opusEncoderCreate == NULL ||
        g_stOpusEncFunc.opusEncoderCtl == NULL)
    {
    ...
    *opusEncoder = g_stOpusEncFunc.opusEncoderCreate(stOpusAttr.samplingRate,
                                                stOpusAttr.channels,
                                                stOpusAttr.application,
                                                &ret);
